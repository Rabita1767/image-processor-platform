...
var consumeQueue = function consumeQueue() {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4
          /*yield*/
          , amqplib_1["default"].connect(process.env.RABBITMQ_URL)];
        ...
        case 2:
          ...
          channel.consume("compress", function (msg) {
            return __awaiter(void 0, void 0, void 0, function () {
              ...
              return __generator(this, function (_b) {
                switch (_b.label) {
                  ...
                  case 1:
                    ...
                    return [4
                    /*yield*/
                    , sharp_1["default"](inputPath).jpeg({
                      quality: 60
                    }).toFile(outputPath)];
                  ...
                  case 2:
                    ...
                    return [4
                    /*yield*/
                    , imageRepository_1["default"].findByIdAndUpdate(imgId, outputPath)];
