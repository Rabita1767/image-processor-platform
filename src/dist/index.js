    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                app.use(cors_1["default"]({ origin: "*" })); // Allow all origins
                app.use(express_1["default"].json());
                app.use(express_1["default"].urlencoded({ extended: true }));
                app.use("/api/v1/user", userRoute_1["default"]);
                app.use("/api/v1/image", imageRoute_1["default"]);
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, rabbitMq_1.rabbitMqConnection()];
            case 2:
                _b.sent();
            ...
            case 3:
                error_1 = _b.sent();
                console.error("Error starting teh server", error_1);
                process.exit(1);
                return [3 /*break*/, 4];
